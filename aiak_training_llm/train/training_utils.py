...
def train_step(forward_step_func, data_iterator, model, optimizer, opt_param_scheduler, config):
    ...
    # Heterogeneous gradient surgery (modality-aware masking).
    # Runs after backward (param.main_grad is ready and reduced across DP) and
    # before optimizer.step() (DistributedOptimizer has not yet copied to main params).
    ...
    if surgery_manager is not None:
        ...
        if (args.curr_iteration == 0
            ...
            surgery_manager.audit_first_step(model)
