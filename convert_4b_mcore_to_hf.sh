...
bash examples/llava_ov_1_5/convert/convert_4b_mcore_to_hf.sh \
    stage_2_instruct_llava_ov_4b-shared-tv-ratio-0.08/iter_0003500 \
    LLaVA-OneVision-1.5-4B-780k-Instruct-shared-tv-ratio-0.08 \
    1 1
# Copy non-model files (e.g., tokenizer config) to the new directory
find /vepfs-mlp2/c20250505/240906016/jjy/LLaVA-OneVision-1.5/LLaVA-OneVision-1.5-4B-stage0 -type f -not -iname '*safetensors*' -exec cp {}  LLaVA-OneVision-1.5-4B-780k-Instruct-shared-tv-ratio-0.08/ ';'