...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/workspace/LLaVA-OneVision-1.5/LLaVA-OneVision-1.5-0.6B-stage0"}
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/workspace/LLaVA-OneVision-1.5/stage_1_alignment_llava_ov_0.6b_release"}
...
SAVE_CKPT_PATH="$(dirname "$AIAK_TRAINING_PATH")/LLaVA-OneVision-2/stage_2_instruct_llava_ov_0.6b-shared-mixed-reg-rl2-${REL_L2_LAMBDA}-cos-${COSINE_LAMBDA}"
...
TRAINING_ARGS=(
    ...
    --gradient-surgery-mask /vepfs-mlp2/c20250505/240906016/jjy/visualization/mlp_routing_masks_adaptive_80_0.6b.pt
