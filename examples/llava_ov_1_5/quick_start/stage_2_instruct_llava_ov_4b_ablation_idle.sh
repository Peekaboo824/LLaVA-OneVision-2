...
#! /bin/bash
# Channel-isolation ablation: only idle channels unfrozen, all others frozen.
...
SAVE_CKPT_PATH="/vepfs-mlp2/c20250505/240906016/jjy/LLaVA-OneVision-2/stage_2_instruct_llava_ov_4b-rank-60-ablation-idle"
...
TRAINING_ARGS=(
    ...
    --gradient-surgery-freeze-ablation idle
)
